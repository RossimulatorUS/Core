...
public:
    ...
    void setupUi(QWidget *Window)
    {
        ...
        m_boutonStartSimulation->setGeometry(QRect(10, 230, 75, 23));
        ...
        m_Resetbutton = new QPushButton(Window);
        m_Resetbutton->setObjectName(QStringLiteral("m_Resetbutton"));
        m_Resetbutton->setGeometry(QRect(10, 260, 75, 23));
        line = new QFrame(Window);
        line->setObjectName(QStringLiteral("line"));
        line->setGeometry(QRect(0, 280, 91, 20));
        ...
        QObject::connect(m_Resetbutton, SIGNAL(pressed()), myGLWidget, SLOT(ResetPressed()));
    ...
    void retranslateUi(QWidget *Window)
    {
        ...
        m_Resetbutton->setText(QApplication::translate("Window", "Reset", 0));
    } // retranslateUi
